                            ...
                            <div class="form-group col-md-6 row">
                                ...
                                <div class="col-sm-7">
                                    <div class="input-group">
                                        <input type="text" class="form-control" aria-describedby="basic-addon2" value="<?= $pelamar['tgl_interview']; ?>" readonly>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                <input type="hidden" name="id_posisi" value="<?= $pelamar['id_posisi']; ?>" required>
                                <div class="form-group row m-t-20">
                                    <label for="nama_pelamar" class="col-sm-2 control-label col-form-label">Nama Pelamar</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="nama_pelamar" name="nama_pelamar" value="<?= $pelamar['nama_pelamar']; ?>" required readonly>
                                    </div>
                                </div>
                                <?php
                                $nilai = 1;
                                    ...
                                    <div class="col-md-12 d-flex">
                                        ...
                                        foreach ($item['data'] as $dataItem) { ?>
                                            <div class="custom-control custom-radio col-md-2">
                                                <input type="radio" class="custom-control-input" name="nilai[<?= $dataItem->id_kriteria ?>]" required value="<?= $no; ?>" id="<?= $dataItem->sub_kriteria . $dataItem->id_kriteria; ?>" <?php foreach ($nilaiPelamar as $item => $value) {
                                                                                                                                                                                                                                            if ($value->id_kriteria == $dataItem->id_kriteria) {
                                                                                                                                                                                                                                                if ($value->nilai ==  $dataItem->value) {
                                                                                                                                                                                                                                        ?> checked="checked" <?php
                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                            // ($value->id_kriteria == $dataItem->id_kriteria ? ($value->nilai == $dataItem->value ? 'checked' : '') : '');
                                                                                                                                                                                                                                        } ?>>
