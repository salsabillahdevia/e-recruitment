                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url() ?>kriteria">Master Data</a></li>
                            <li class="breadcrumb-item"><a href="<?= base_url() ?>kriteria">Master Data Kriteria</a></li>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-danger">Note : Kriteria harus 5, tidak kurang dan tidak lebih</p>
                        <div class="col-md-4">
                        ...
                        <table class="table m-t-20">
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><?= $data['sifat']; ?></td>
                                    <td>
                                        <a class="btn btn-outline-primary" href="<?= base_url('kriteria/kriteria/' . $data['id_posisi'] . '/' . $data['id_kriteria']); ?>"><i class="mdi mdi-pencil"></i> Ubah</a>
                                        <a class="btn btn-outline-danger" onclick="return confirm('Ingin menghapus kriteria <?= $data['kriteria'] ?>?');" href="<?= base_url('kriteria/delete/'  . $data['id_posisi'] . '/' . $data['id_kriteria']); ?>"><i class="mdi mdi-delete"></i> Hapus</a>
                                    </td>
                                </tr>
                            <?php
                            endforeach
    ...
    <div class="modal fade" id="tambahKriteria" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('kriteria/kriteria/' . $lowongan['id_posisi']) ?>" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row m-t-20">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="text" class="form-control" id="kriteria" name="sub_kriteria1" placeholder="Sub Kriteria 1" required>
                                <input type="text" class="form-control" id="kriteria" name="sub_kriteria2" placeholder="Sub Kriteria 2" required>
                                <input type="text" class="form-control" id="kriteria" name="sub_kriteria3" placeholder="Sub Kriteria 3" required>
                                <input type="text" class="form-control" id="kriteria" name="sub_kriteria4" placeholder="Sub Kriteria 4" required>
                                <input type="text" class="form-control" id="kriteria" name="sub_kriteria5" placeholder="Sub Kriteria 5" required>
                            </div>
                        </div>
                        <div class="form-group row m-t-20">
